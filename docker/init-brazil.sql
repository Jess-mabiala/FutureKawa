\connect futurekawa_brazil


-- ═══════════════════════════════════════════════════════════
--  FutureKawa — Init base Brésil
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
--  DONNÉES DE RÉFÉRENCE — Brésil
--  Temp idéale : 29°C ± 3°C | Humidité idéale : 55% ± 2%
-- ═══════════════════════════════════════════════════════════

INSERT INTO public.country (id, code, name, ideal_temp, ideal_humidity, temp_tolerance, humidity_tolerance)
VALUES (1, 'BR', 'Brésil', 29.00, 55.00, 3.00, 2.00);

INSERT INTO public.exploitation (id, country_id, name, location)
VALUES
    (1, 1, 'Exploitation Amazônia', 'Manaus, Amazonas'),
    (2, 1, 'Exploitation Cerrado', 'Brasília, DF');

INSERT INTO public.warehouse (id, exploitation_id, name, address)
VALUES
    (1, 1, 'Entrepôt BR-1', 'Manaus, Amazonas'),
    (2, 1, 'Entrepôt BR-2', 'Manaus, Amazonas'),
    (3, 2, 'Entrepôt BR-3', 'Brasília, DF');

INSERT INTO public.iot_device (id, warehouse_id, mac_address, firmware_version)
VALUES
    (1, 1, 'AA:BB:CC:DD:EE:01', 'v1.2.0'),
    (2, 2, 'AA:BB:CC:DD:EE:02', 'v1.2.0'),
    (3, 3, 'AA:BB:CC:DD:EE:03', 'v1.2.0');

INSERT INTO public.lot (id, lot_code, warehouse_id, storage_date, status)
VALUES
    (1, 'BR-LOT-2024-001', 1, '2024-06-01', 'compliant'),
    (2, 'BR-LOT-2024-002', 2, '2024-08-15', 'compliant'),
    (3, 'BR-LOT-2025-001', 3, '2025-01-10', 'compliant');

-- Remise à zéro des séquences après insertion

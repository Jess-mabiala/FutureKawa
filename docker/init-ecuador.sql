\connect futurekawa_ecuador


-- ═══════════════════════════════════════════════════════════
--  FutureKawa — Init base Équateur
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
--  DONNÉES DE RÉFÉRENCE — Équateur
--  Temp idéale : 31°C ± 3°C | Humidité idéale : 60% ± 2%
-- ═══════════════════════════════════════════════════════════

INSERT INTO public.country (id, code, name, ideal_temp, ideal_humidity, temp_tolerance, humidity_tolerance)
VALUES (1, 'EC', 'Équateur', 31.00, 60.00, 3.00, 2.00);

INSERT INTO public.exploitation (id, country_id, name, location)
VALUES
    (1, 1, 'Exploitation Pichincha', 'Quito, Pichincha'),
    (2, 1, 'Exploitation Guayas', 'Guayaquil, Guayas');

INSERT INTO public.warehouse (id, exploitation_id, name, address)
VALUES
    (1, 1, 'Entrepôt EC-1', 'Quito, Pichincha'),
    (2, 1, 'Entrepôt EC-2', 'Quito, Pichincha'),
    (3, 2, 'Entrepôt EC-3', 'Guayaquil, Guayas');

INSERT INTO public.iot_device (id, warehouse_id, mac_address, firmware_version)
VALUES
    (1, 1, 'CC:DD:EE:FF:AA:01', 'v1.2.0'),
    (2, 2, 'CC:DD:EE:FF:AA:02', 'v1.2.0'),
    (3, 3, 'CC:DD:EE:FF:AA:03', 'v1.2.0');

INSERT INTO public.lot (id, lot_code, warehouse_id, storage_date, status)
VALUES
    (1, 'EC-LOT-2024-001', 1, '2024-04-15', 'compliant'),
    (2, 'EC-LOT-2024-002', 2, '2024-10-20', 'compliant'),
    (3, 'EC-LOT-2025-001', 3, '2025-03-01', 'compliant');
